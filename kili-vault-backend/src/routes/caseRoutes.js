...
router.post("/pre-development/preview", caseController.previewPreDevelopment);
router.post("/pre-development/submit", caseController.submitPreDevelopment);
router.get("/observations/mine", caseController.listMyObservations);
...
router.get("/:id/property-record", caseController.getPropertyRecord);
